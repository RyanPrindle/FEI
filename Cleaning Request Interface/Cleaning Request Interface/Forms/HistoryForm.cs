...
#region Properties
        ...
        public HistoryForm(MainForm mainForm)
        {
            ...
            infoIcon = Cleaning_Request_Interface.Properties.Resources.blueInfoButtonIcon;
        ...
        {
            int pad = 10;
            int btnHeight = (panelDGV.Height - panelFilter.Height - 2 * pad) / 2;
            btnQuit.Location = new Point(panelFilter.Location.X ,panelDGV.Height + pad - btnHeight + 3);
            btnMain.Location = new Point(panelFilter.Location.X, panelDGV.Height - 2 * btnHeight + 3);
            btnQuit.Height = btnMain.Height = btnHeight;
            btnQuit.Font = btnMain.Font = buttonReset.Font = mMainForm.btnFont;
        }
