    ...
    class OutgasDB 
    {
        private static string OUTGASDBCONNSTRING = @"Provider=Microsoft Office 12.0 Access Database Engine OLE DB Provider;Data Source= " +
            // @"D:\Desktop\Camco Vacuum Furnace\BE\Outgas_be.accdb";
                                      //@"C:\Users\rprindle\Desktop\TFE_VacuumFurnaceScheduler\BE-TFE_VacuumFurnaceScheduler" +
                                       @"C:\Dev\BE-TFE_VacuumFurnaceScheduler\" +
                                        //@"C:\dev\TFE_Projects\TFE_VacuumFurnaceScheduler\BE-TFE_VacuumFurnaceScheduler\" +
                                        "Outgas_be.accdb";
